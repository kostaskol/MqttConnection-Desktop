...
public class DataBaseManagerThread extends Thread {
    ...
    public DataBaseManagerThread(String threadName, String op, SettingsProfile prof) {
        super(threadName);
        this.threadName = threadName;
        this.dbManager = new DataBaseManager();
        this.operation = op;
    ...
    private void deleteProfile(SettingsProfile prof) {
